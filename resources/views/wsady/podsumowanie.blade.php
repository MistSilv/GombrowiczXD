    ...
    <div class="container mx-auto px-4 py-6 text-white max-w-4xl bg-gray-900/70 rounded-xl">
        ...
        @else
            ...
            <div class="mb-6 flex flex-wrap justify-center gap-4">
                <a href="{{ route('export.wsady', ['zakres' => $zakresSlug, 'format' => 'xlsx', 'date' => $dateForUrl]) }}"
                ...
                <a href="{{ route('export.wsady', ['zakres' => $zakresSlug, 'format' => 'csv', 'date' => $dateForUrl]) }}"
                ...
                <table class="min-w-full divide-y divide-gray-700 text-sm">
                    <thead class="bg-gray-800 text-purple-200">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left uppercase tracking-wider font-semibold">Łączny wsad (szt.)</th>
                        </tr>
                    </thead>
